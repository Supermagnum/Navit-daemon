"""
Read accelerometer and gyroscope from Linux IIO sysfs.
...
class IIOReader:
    """
    Read accelerometer and/or gyroscope from IIO sysfs.

    Units: accelerometer m/s^2, gyroscope deg/s (for imufusion compatibility).
    """
